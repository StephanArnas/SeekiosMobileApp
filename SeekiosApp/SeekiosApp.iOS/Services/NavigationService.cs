...
namespace SeekiosApp.Services
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        private UIStoryboard _mainStoryboard = null;

        public static iOS.Menu.MenuController LeftMenuView { get; set; }
                    ...
                    try
                    {
                        ...
                        else if (_mainStoryboard != null)
                        {
                            if (pageKey == App.TUTORIAL_BACKGROUND_FIRST_LAUNCH_PAGE)
                            {
                                ...
                                else controller = _mainStoryboard.InstantiateViewController(item.StoryboardControllerKey);
                            }
                            else
                            {
